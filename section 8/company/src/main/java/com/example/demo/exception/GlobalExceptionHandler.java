...
public class GlobalExceptionHandler  extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorResponseDto> handleResourceNotFoundException(ResourceNotFoundException exception, WebRequest request) {
		ErrorResponseDto errorDto = new ErrorResponseDto(request.getDescription(false), exception.getMessage(), LocalDateTime.now() , HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<ErrorResponseDto> handleResourceNotModifiedException(ResourceNotModifiedException exception, WebRequest request) {
		ErrorResponseDto errorDto = new ErrorResponseDto(request.getDescription(false), exception.getMessage(), LocalDateTime.now() , HttpStatus.CONFLICT);
	...
	public ResponseEntity<ErrorResponseDto> handleGlobalException(GlobalException exception, WebRequest request) {
		ErrorResponseDto errorDto = new ErrorResponseDto(request.getDescription(false), exception.getMessage(), LocalDateTime.now() , HttpStatus.INTERNAL_SERVER_ERROR);
	...
	public ResponseEntity<ErrorResponseDto> handleResourceAlreadyExistsException(ResourceAlreadyExistsException exception, WebRequest request) {
		ErrorResponseDto errorDto = new ErrorResponseDto(request.getDescription(false), exception.getMessage(), LocalDateTime.now() , HttpStatus.BAD_REQUEST);
